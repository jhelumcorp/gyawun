...
class JSHomeScreen extends StatelessWidget {
  const JSHomeScreen({super.key});

  @override
  Widget build(BuildContext context) {
    return BlocProvider(create: (_) => HomeCubit(sl<JioSaavn>()), child: const JSHomeScreenView());
  }
}

class JSHomeScreenView extends StatefulWidget {
  const JSHomeScreenView({super.key});

  @override
  State<JSHomeScreenView> createState() => _JSHomeScreenViewState();
}

class _JSHomeScreenViewState extends State<JSHomeScreenView> {
